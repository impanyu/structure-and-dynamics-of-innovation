...
corpus. We find (i) an inverted-U in anticipation accuracy over reading
scope, peaking at 800 papers---a coherent sub-area, not one topic---at
tier-1 accuracy 31\%, with the whole narrow-to-mid band (100--1600)
well ahead of broad scopes, and \emph{both} dial endpoints on the
parametric floor: agents reading nothing (13\%) and unrestricted generalists
reading anything (14\%) are indistinguishable; (ii) idea
production peaks at a mid-narrow scope and falls as reading widens; (iii) team size is a pure throughput
...
\emph{helps} generalists (tier-1 accuracy 27\% vs.\ 14\%, with more ideas
produced): agents navigate semantically, not structurally, and the human
citation topology acts as a distractor rather than a scaffold---whereas
removing semantic search \emph{hurts}, because search is where genuine
