...
writes are always free. Each tier cell reports acc@$\geq$3 (share of
ideas realized at level $\geq 3$ by a post-cutoff paper in the tier;
...
\midrule
C2 & 400   & \textbf{83} & 16\% (13) / 0.89 & 24\% / 1.19 & 67\% / \textbf{2.48} \\
C3 & 800   & 74 & \textbf{22\% (16) / 1.04} & \textbf{30\% / 1.38} & \textbf{69\%} / 2.43 \\
C4 & 1600  & 67 & 18\% (12) / 0.78 & 27\% / 1.04 & 40\% / 1.60 \\
C5 & 3200  & 55 & 15\% (8) / 0.69  & 25\% / 1.05 & 55\% / 2.02 \\
C6 & 6400  & 54 & 15\% (8) / 0.74  & 24\% / 1.06 & 61\% / 2.22 \\
C1 & $\infty$ & 50 & 10\% (5) / 0.50 & 12\% / 0.64 & 44\% / 1.68 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
\textbf{tier-2 acc / mean} & \textbf{tier-3 acc / mean} \\
\midrule
10  & 12 (1.2)  & 17\% (2) / 0.67  & 25\% (3) / 1.08  & 50\% (6) / 2.00 \\
50  & 103 (2.1) & 12\% (12) / 0.55 & 17\% (17) / 0.86 & 49\% (50) / 1.98 \\
100 & 180 (1.8) & 11\% (20) / 0.61 & 16\% (28) / 0.83 & 44\% (80) / 1.87 \\
150 & 280 (1.9) & 11\% (32) / 0.66 & 20\% (57) / 0.95 & 50\% (139) / 1.86 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
\toprule
 ...
 \textbf{tier-2 acc / mean} & \textbf{tier-3 acc / mean} \\
\midrule
no edges & 60 & \textbf{20\% (12) / 0.93} & \textbf{20\% / 1.07} & \textbf{47\% / 1.97} \\
no jumps & \textbf{63} & 13\% (8) / 0.62 & 16\% / 0.71 & 44\% / 1.92 \\
C1 (full) & 50 & 10\% (5) / 0.50 & 12\% / 0.64 & 44\% / 1.68 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
