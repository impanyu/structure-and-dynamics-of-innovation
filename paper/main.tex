...
tier-1 accuracy 31\%, with the whole narrow band (100--800) well ahead
of broad scopes, and \emph{both} dial endpoints on the parametric
floor: agents reading nothing (13\%) and unrestricted generalists
...
\item \textbf{An inverted-U in idea quality, peaking at a sub-area
  ...
  (31\% vs.\ 14\% for generalists), with the whole narrow band
  $m \in \{100, 400, 800\}$ (24--31\%) well above broad scopes
...
C5 & 1600  & 67 & 15\% (10) / 0.33 & 28\% (19) / 0.67 & 54\% (36) / 1.37 \\
...
runs 24\% $\to$ 24\% $\to$ \textbf{31\%} $\to$ 15\% $\to$ 15\%
...
and mean level in tiers 1--2; the whole narrow band (100--800) clears
every broad scope; and even the extreme $m{=}100$ core---smaller than
the median natural topic of 228 papers---holds 24\%, refuting the
pre-registered fear of material starvation at the narrow end.
...
peaks at $m{=}400$ and falls as scope widens (67, 83, 74, 67, 55, 54,
...
earlier idea. Table~\ref{tab:provenance} aggregates all 1{,}337
evaluated ideas across our experiments. Realized and unrealized ideas
are preceded by the \emph{same volume} of reading ($\sim$10.7 reads);
what differs is its composition. Ideas realized in recognized venues
(tier~1) grew out of windows with more search-driven reads (5.76
vs.\ 4.62), fewer link-driven reads (3.75 vs.\ 4.57), fewer jumps, and
...
over all 1{,}337 evaluated ideas from every run in the paper.}
...
\toprule
 ...
 \textbf{own-idea} \\
\midrule
tier-1 realized & 231 & 10.62 & 5.77 & \textbf{5.76} & \textbf{3.75} & 1.03 & 0.08 \\
tier-2 realized & 316 & 10.56 & 5.61 & 5.59 & 3.79 & 1.10 & 0.07 \\
tier-3 realized & 884 & 10.69 & 5.27 & 5.18 & 4.12 & 1.30 & 0.09 \\
unrealized      & 453 & 10.77 & 5.10 & 4.62 & 4.57 & 1.42 & 0.16 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
