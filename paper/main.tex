...
\midrule
no edges & 60 & \textbf{20\% (12)} & \textbf{20\%} & \textbf{47\%} & \textbf{0.93} \\
no jumps & \textbf{63} & 13\% (8) & 16\% & 44\% & 0.62 \\
C1 (full) & 50 & 10\% (5) & 12\% & 44\% & 0.50 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
smaller (Table~\ref{tab:noedges}, middle row: 63 ideas at 13\% vs.\ 50
at 10\%)---unsurprisingly, since C1 agents only jumped $\sim$20 times
...
runs per arm (12/60 and 8/63 vs.\ 5/50 hits); the directions, the
